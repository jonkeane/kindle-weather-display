...
rsvg-convert --background-color=white -o weather-script-output-current.png outputData/weather-script-output-current.svg
...
rsvg-convert --background-color=white -o weather-script-output-hourly.png outputData/weather-script-output-hourly.svg
...
rsvg-convert --background-color=white -o weather-script-output-daily.png outputData/weather-script-output-daily.svg
