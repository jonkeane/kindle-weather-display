...
convert weather-script-output-current.png -rotate 90 weather-script-output-current-rotated.png
...
convert weather-script-output-hourly.png -rotate 90 weather-script-output-hourly-rotated.png
